Shuffle Offconst songs = [
    ...
    { title: "Ek Din", url: "./songs/Ek Din.mp3" },
    { title: "O Mere Dil K Chain", url: "./songs/O Mere Dil K Chain.mp3" },
    { title: "Hosh Walo Ko Khabar Kya", url: "./songs/Hosh Walo Ko Khabar Kya.mp3" },
    { title: "Pal Pal Dil K Paas", url: "./songs/Pal Pal Dil K Paas.mp3" },
    { title: "Tujh Me Rab Dikhta Hai", url: "./songs/Tujh Me Rab Dikhta Hai.mp3" },
    { title: "Ishq Bulava", url: "./songs/Ishq Bulava.mp3" },
    { title: "Darkhaast", url: "./songs/Darkhaast.mp3" },
    { title: "Jab Tak", url: "./songs/Jab Tak.mp3" },
    { title: "Yeh Fitoor", url: "./songs/Yeh Fitoor.mp3" },
    { title: "Tera Fitoor", url: "./songs/Tera Fitoor.mp3" },
    { title: "Tere Naina", url: "./songs/Tere Naina.mp3" },
