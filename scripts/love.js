const songs = [
    ...
    { title: "Sahiba", url: "./songs/Sahiba.mp3" },
    { title: "Pal Pal", url: "./songs/Pal Pal.mp3" },
    { title: "Paaro", url: "./songs/Paaro.mp3" },
    { title: "Ae Ajnabee", url: "./songs/Ae Ajnabee.mp3" },
    { title: "Dooron Dooron", url: "./songs/Dooron Dooron.mp3" },
    { title: "Tainu Khabar Nahi", url: "./songs/Tainu Khabar Nahi.mp3" },
    { title: "Finding Her", url: "./songs/Finding Her.mp3" },
    ...
    { title: "Akh Lad Jaave", url: "./songs/Akh Lad Jaave.mp3" },
    { title: "Jungu", url: "./songs/Jugnu.mp3" },
